...
print()
print("기술통계:")
print(df[['국어', '영어', '수학', '과학', '사회']].describe().round(1))`
...
print(f"가장 쉬운 과목: {subjects[np.argmax(means)]} (평균 {max(means):.1f})")`

export default function StudentScores() {
  return (
    <>
      <SEOHead title="학생 성적 분석" description="기술통계와 히스토그램으로 학생 성적 데이터를 분석합니다." />
      <section className="page-header">
        <div className="container">
          <h1>학생 성적 분석</h1>
          <p>기술통계, 히스토그램, 상관분석으로 학생 성적을 분석합니다</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="lesson-body">
            ...
            <div className="callout-box">
              <h3>프로젝트 목표</h3>
              <p>50명 학생의 5과목 성적 데이터를 생성하고, 분포 확인, 상관분석, 종합 리포트를 만들어봅니다.
              <strong> 난이도: 초급</strong> | 핵심 스킬: 기술통계, 히스토그램, 상관분석</p>
            </div>

            <h2>데이터 설명</h2>
            <p>50명 학생의 국어, 영어, 수학, 과학, 사회 성적입니다. 각 과목은 정규분포를 따르며, 총점과 평균을 계산합니다.</p>

            <h2>1단계: 데이터 생성 및 기술통계</h2>
            <p>정규분포로 성적 데이터를 생성하고, describe()로 기술통계량을 확인합니다.</p>
            <CodeEditor title="1단계: 데이터 생성 및 기술통계" initialCode={step1} />

            <h2>2단계: 성적 분포 시각화</h2>
            <p>과목별 히스토그램으로 점수 분포를 확인하고 평균선을 표시합니다.</p>
            <CodeEditor title="2단계: 성적 분포 (히스토그램)" initialCode={step2} />

            <h2>3단계: 과목 간 상관분석</h2>
            <p>상관계수를 계산하고 seaborn 히트맵으로 과목 간 관계를 시각화합니다.</p>
            <CodeEditor title="3단계: 과목 간 상관분석" initialCode={step3} />

            <h2>4단계: 종합 분석</h2>
            <p>과목별 평균, 산점도, 상위/하위 비교, 등급 분포를 하나의 대시보드로 구성합니다.</p>
            <CodeEditor title="4단계: 종합 분석 대시보드" initialCode={step4} />

            <div className="callout-box">
              <h3>실습 과제</h3>
              <ul>
                <li>과목별 표준편차를 비교하는 바 차트를 그려보세요.</li>
                <li>영어와 과학의 산점도를 그리고 상관관계를 해석해보세요.</li>
                <li>성별 컬럼을 추가하고, 성별에 따른 과목별 평균 차이를 분석해보세요.</li>
              </ul>
            </div>

            <div className="lesson-nav">
              <Link to="/projects/cafe-sales" className="lesson-nav-btn prev">&larr; 이전: 카페 매출 분석</Link>
              <Link to="/projects/survey-dashboard" className="lesson-nav-btn next">다음: 설문조사 대시보드 &rarr;</Link>
            </div>
          </div>
        </div>
      </section>
