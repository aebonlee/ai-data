...
const step2 = `import pandas as pd
import numpy as np
...
print(f"\\n[RFM 점수 상위 10명]")
print(rfm.sort_values('RFM_total', ascending=False).head(10)[['고객ID', 'Recency', 'Frequency', 'Monetary', 'R_score', 'F_score', 'M_score', 'RFM_total']])`

const step3 = `# 고객 세그먼트 분류
...
print(f"하위 10% CLV: {customer_stats['CLV_12m'].quantile(0.1):,.0f}원")`
...
export default function Customer() {
  return (
    <>
      <SEOHead title="고객 데이터 분석" description="RFM 분석, 코호트 분석, CLV 추정으로 고객 데이터를 분석합니다." />
      <section className="page-header">
        <div className="container">
          <h1>고객 데이터 분석</h1>
          <p>RFM 분석, 코호트 분석, CLV 추정으로 고객 데이터를 분석합니다</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="playground-body">
            ...
            <div className="callout-box">
              <h3>프로젝트 목표</h3>
              <p>고객 거래 데이터를 생성하고, RFM 분석, 세그먼트 분류, 코호트 분석, CLV 추정, 종합 대시보드를 구성합니다.</p>
            </div>

            <h2>데이터 설명</h2>
            <ul>
              <li><strong>고객ID</strong> — 1001~2000번 고객</li>
              <li><strong>주문일</strong> — 2023년 1년간 거래 내역</li>
              <li><strong>주문금액</strong> — 로그정규분포 기반 금액</li>
              <li><strong>카테고리</strong> — 전자제품, 의류, 식품, 생활용품, 도서</li>
              <li><strong>채널</strong> — 웹, 앱, 오프라인</li>
            </ul>
            ...
            <h2>2단계: RFM 계산</h2>
            <CodeEditor title="2단계: RFM 계산" initialCode={step2} />

            <h2>3단계: 세그먼트 분류</h2>
            <CodeEditor title="3단계: 세그먼트 분류" initialCode={step3} />

            <h2>4단계: 세그먼트 시각화</h2>
            <CodeEditor title="4단계: 세그먼트 시각화" initialCode={step4} />

            <h2>5단계: 코호트 분석</h2>
            <CodeEditor title="5단계: 코호트 분석" initialCode={step5} />

            <h2>6단계: CLV 추정</h2>
            <CodeEditor title="6단계: CLV 추정" initialCode={step6} />
