import{j as e,L as a}from"./index-gcHXxZUQ.js";import{S as r}from"./SEOHead-bamOYJVC.js";import{C as s}from"./CodeEditor-DFGQeCvX.js";const t=`import numpy as np
import pandas as pd
...
print()
print("기술통계:")
print(df[['나이', '연봉', '근속연수', '만족도', '성과점수']].describe().round(1))`,n=`import matplotlib.pyplot as plt
...
print("부서별 요약:")
print(dept_summary)`,l=`import seaborn as sns
...
for i in range(len(num_cols)):
    for j in range(i+1, len(num_cols)):
        r = corr.iloc[i, j]
        if abs(r) >= 0.3:
            print(f"  {num_cols[i]} ↔ {num_cols[j]}: {r:.2f}")`,i=`fig, axes = plt.subplots(2, 2, figsize=(13, 10))
...
print(f"이직자 평균 만족도: {leave['만족도'].mean():.2f} vs 재직자: {stay['만족도'].mean():.2f}")`;function c(){return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"인사 데이터 분석",description:"다변량 인사 데이터를 박스플롯과 히트맵으로 분석합니다."}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h1",{children:"인사 데이터 분석"}),e.jsx("p",{children:"다변량 분석, 박스플롯, 히트맵으로 인사 데이터를 분석합니다"})]})}),e.jsx("section",{className:"section lesson-content",children:e.jsx("div",{className:"container",children:e.jsxs("div",{className:"playground-body",children:[e.jsxs("div",{className:"callout-box",children:[e.jsx("h3",{children:"프로젝트 목표"}),e.jsxs("p",{children:["200명 직원의 인사 데이터를 생성하고, 부서별 비교, 상관 히트맵, 이직 예측 인사이트를 도출합니다.",e.jsx("strong",{children:" 난이도: 고급"})," | 핵심 스킬: 다변량 분석, 박스플롯, 히트맵"]})]}),e.jsx("h2",{children:"데이터 설명"}),e.jsx("p",{children:"5개 부서 200명 직원의 인사 데이터입니다. 연봉은 부서 기본급 + 나이 보정 + 랜덤 노이즈로 생성됩니다."}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"부서"})," — 개발, 마케팅, 영업, 인사, 재무"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"나이 / 성별 / 근속연수"})," — 기본 인적 정보"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"연봉"})," — 부서별 기본급 + 나이 보정 (만원)"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"만족도 / 성과점수"})," — 1~5점 척도"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"초과근무"})," — 낮음, 보통, 높음"]}),e.jsxs("li",{children:[e.jsx("strong",{children:"이직여부"})," — 0(재직), 1(이직), 이직률 약 15%"]})]}),e.jsx("h2",{children:"1단계: 데이터 생성 및 탐색"}),e.jsx("p",{children:"부서별 연봉 차이가 반영된 인사 데이터를 생성하고 기술통계를 확인합니다."}),e.jsx(s,{title:"1단계: 데이터 생성 및 탐색",initialCode:t}),e.jsx("h2",{children:"2단계: 부서별 분석 (박스플롯)"}),e.jsx("p",{children:"부서별 연봉, 만족도, 성과점수의 분포를 박스플롯으로 비교합니다."}),e.jsx(s,{title:"2단계: 부서별 분석 (박스플롯)",initialCode:n}),e.jsx("h2",{children:"3단계: 상관관계 히트맵"}),e.jsx("p",{children:"수치형 변수 간 상관계수를 계산하고 seaborn 히트맵으로 시각화합니다."}),e.jsx(s,{title:"3단계: 상관관계 히트맵",initialCode:l}),e.jsx("h2",{children:"4단계: 다변량 분석"}),e.jsx("p",{children:"나이-연봉 관계, 초과근무 영향, 이직자 특성, 성별 비교를 종합 분석합니다."}),e.jsx(s,{title:"4단계: 다변량 종합 분석",initialCode:i}),e.jsxs("div",{className:"callout-box",children:[e.jsx("h3",{children:"실습 과제"}),e.jsxs("ul",{children:[e.jsx("li",{children:"성별에 따른 부서별 연봉 차이를 분석해보세요 (groupby 2개 변수)."}),e.jsx("li",{children:"만족도가 2.5 이하인 직원의 특성(부서, 초과근무, 이직여부)을 분석해보세요."}),e.jsx("li",{children:"근속연수와 만족도의 산점도를 그리고, 이직여부에 따라 색상을 다르게 표시해보세요."})]})]}),e.jsxs("div",{className:"lesson-nav",children:[e.jsx(a,{to:"/projects/product-review",className:"lesson-nav-btn prev",children:"← 이전: 상품 리뷰 분석"}),e.jsx(a,{to:"/projects",className:"lesson-nav-btn next",children:"프로젝트 목록 →"})]})]})})})]})}export{c as default};
