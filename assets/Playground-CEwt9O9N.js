import{r as t,j as e,b as F}from"./index-CfCOa64r.js";import{S as M}from"./SEOHead-Dj7Nttb3.js";let w=null;function I(){return w||(w=new Worker(new URL("/assets/pyodide.worker-CgIyxfYa.js",import.meta.url),{type:"classic"})),w}function O(){const[a,l]=t.useState("idle"),[n,o]=t.useState(""),[r,p]=t.useState(""),[u,m]=t.useState([]),f=t.useRef(null);t.useEffect(()=>(f.current=I(),()=>void 0),[]);const j=t.useCallback((y,v=[])=>{const c=f.current;if(!c)return;l("loading"),o(""),p(""),m([]);const x=[],g=_=>{const{type:S,text:N,message:E,status:C}=_.data;switch(S){case"status":l(C);break;case"stdout":{const k=/__SVG_START__([\s\S]*?)__SVG_END__/g;let h=N,d;for(;(d=k.exec(N))!==null;)x.push(d[1]),h=h.replace(d[0],"");x.length>0&&m([...x]),h.trim()&&o(s=>s+h);break}case"stderr":o(k=>k+N);break;case"error":l("error"),p(E),c.removeEventListener("message",g);break;case"done":l("done"),c.removeEventListener("message",g);break}};c.addEventListener("message",g),c.postMessage({type:"run",code:y,inputs:v})},[]),i=t.useCallback(()=>{l("idle"),o(""),p(""),m([])},[]);return{status:a,output:n,errorMsg:r,svgOutputs:u,runCode:j,resetOutput:i}}const R={idle:{icon:"fa-circle-play",label:"실행 대기",color:"#6B7280"},loading:{icon:"fa-spinner fa-spin",label:"Pyodide 로딩...",color:"#F59E0B"},running:{icon:"fa-gear fa-spin",label:"실행 중...",color:"#3B82F6"},done:{icon:"fa-circle-check",label:"완료",color:"#10B981"},error:{icon:"fa-circle-xmark",label:"오류",color:"#EF4444"}};function L({initialCode:a="",title:l=""}){const[n,o]=t.useState(a),[r,p]=t.useState(!1),[u,m]=t.useState(""),f=t.useRef(null),j=t.useRef(null),{status:i,output:y,errorMsg:v,svgOutputs:c,runCode:x,resetOutput:g}=O(),_=t.useCallback(()=>{j.current&&f.current&&(j.current.scrollTop=f.current.scrollTop)},[]),S=n.split(`
`).length,N=Array.from({length:S},(s,b)=>b+1),E=t.useCallback(s=>{if(s.key==="Tab"){s.preventDefault();const{selectionStart:b,selectionEnd:T}=s.target,A=n.slice(0,b),B=n.slice(T),D=A+"    "+B;o(D),requestAnimationFrame(()=>{s.target.selectionStart=s.target.selectionEnd=b+4})}(s.ctrlKey||s.metaKey)&&s.key==="Enter"&&(s.preventDefault(),C())},[n]),C=t.useCallback(()=>{if(/\binput\s*\(/.test(n)&&!r){p(!0);return}const s=u?u.split(`
`):[];x(n,s),p(!1)},[n,u,r,x]),k=t.useCallback(()=>{navigator.clipboard.writeText(n)},[n]),h=t.useCallback(()=>{o(a),g(),p(!1),m("")},[a,g]),d=R[i]||R.idle;return e.jsxs("div",{className:"code-editor",children:[l&&e.jsxs("div",{className:"code-editor-title",children:[e.jsx("i",{className:"fa-solid fa-code"})," ",l]}),e.jsxs("div",{className:"code-editor-toolbar",children:[e.jsxs("button",{className:"editor-btn editor-btn-run",onClick:C,disabled:i==="loading"||i==="running",children:[e.jsx("i",{className:`fa-solid ${i==="running"?"fa-spinner fa-spin":"fa-play"}`}),i==="loading"?"로딩...":i==="running"?"실행 중":"실행"]}),e.jsxs("button",{className:"editor-btn",onClick:k,children:[e.jsx("i",{className:"fa-solid fa-copy"})," 복사"]}),e.jsxs("button",{className:"editor-btn",onClick:h,children:[e.jsx("i",{className:"fa-solid fa-rotate-left"})," 초기화"]}),e.jsxs("div",{className:"editor-status",children:[e.jsx("i",{className:`fa-solid ${d.icon}`,style:{color:d.color}}),e.jsx("span",{style:{color:d.color},children:d.label})]}),e.jsx("span",{className:"editor-shortcut",children:"Ctrl+Enter"})]}),e.jsxs("div",{className:"code-editor-body",children:[e.jsx("div",{className:"line-numbers",ref:j,children:N.map(s=>e.jsx("div",{className:"line-num",children:s},s))}),e.jsx("textarea",{ref:f,className:"code-textarea",value:n,onChange:s=>o(s.target.value),onScroll:_,onKeyDown:E,spellCheck:!1,autoComplete:"off",autoCorrect:"off"})]}),r&&e.jsxs("div",{className:"code-input-area",children:[e.jsxs("label",{children:[e.jsx("i",{className:"fa-solid fa-keyboard"})," 입력값 (input마다 줄바꿈):"]}),e.jsx("textarea",{value:u,onChange:s=>m(s.target.value),placeholder:"input() 에 전달할 값을 한 줄씩 입력하세요",rows:3}),e.jsxs("button",{className:"editor-btn editor-btn-run",onClick:C,children:[e.jsx("i",{className:"fa-solid fa-play"})," 입력값과 함께 실행"]})]}),(y||v||c.length>0)&&e.jsxs("div",{className:"code-output-area",children:[e.jsxs("div",{className:"code-output-header",children:[e.jsx("i",{className:"fa-solid fa-terminal"})," 출력 결과"]}),c.map((s,b)=>e.jsx("div",{className:"svg-output",dangerouslySetInnerHTML:{__html:s}},b)),y&&e.jsx("pre",{className:"code-output",children:y}),v&&e.jsx("pre",{className:"code-error",children:v})]})]})}const P=[{label:"기본 분석",icon:"fa-solid fa-chart-simple",code:`import pandas as pd
import numpy as np
